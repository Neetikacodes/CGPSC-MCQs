...
// ---------- Cover screen ----------
function buildCover(){
  const meta2024 = QUIZ_DATA['2024'];
  const meta2022 = QUIZ_DATA['2022'];
  el('meta-2024-count').textContent = meta2024.length;
  el('meta-2022-count').textContent = meta2022.length;

  el('booklet-2024').addEventListener('click', () => startPaper('2024'));
  el('booklet-2022').addEventListener('click', () => startPaper('2022'));
}
